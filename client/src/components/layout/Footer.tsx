      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-[hsl(var(--solana-teal))] transition-colors">About Us</a></li>
              <li><a href="#" className="text-gray-300 hover:text-[hsl(var(--solana-teal))] transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-300 hover:text-[hsl(var(--solana-teal))] transition-colors">Careers</a></li>
              <li><a href="#" className="text-gray-300 hover:text-[hsl(var(--solana-teal))] transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="#" className="text-gray-300 hover:text-[hsl(var(--solana-teal))] transition-colors">
            ...
            <div className="mt-2 flex">
              <input type="email" className="flex-grow bg-white/5 border border-white/20 rounded-l-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[hsl(var(--solana-purple))]" placeholder="Your email" />
              <button className="bg-[hsl(var(--solana-purple))] rounded-r-lg px-4 py-2 text-white font-medium">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2023 NymSOL. All rights reserved.</p>
